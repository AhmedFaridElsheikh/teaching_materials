...
Practical lab sessions — circuits built and tested on breadboards. Each lab folder contains a circuit explanation, wiring guide, demo video, and where available a photo of the build.
